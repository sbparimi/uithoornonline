...
export function DiscoveryDirectory({ title, eyebrow, intro, items, cta = 'Plaats je bedrijf' }: { title: string; eyebrow: string; intro: string; items: Item[]; cta?: string }) {
  ...
  return <main className="uo-directory"><header className="uo-header"><div className="uo-header-inner"><a href="/" className="uo-brand"><span className="uo-brand-mark">u</span><span>ithoorn<span>.online</span></span></a><nav className="uo-nav"><a href="/services">Diensten</a><a href="/#food">Indian food</a></nav><div className="uo-header-actions"><span className="uo-location"><MapPin /> Uithoorn & De Kwakel</span><a href="/businesses">Aanbieders</a><a className="uo-header-cta" href="/request">Plaats je bedrijf</a></div></div></header>
