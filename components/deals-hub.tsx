...
export default function DealsHub({ deals }: { deals: Deal[] }) {
  ...
  return <main className="discovery-page"><header className="discovery-header"><a href="/" className="discovery-brand"><span className="discovery-brand-mark"><img src="/icon.svg" alt="" /></span>Uithoorn<span>Online</span></a><nav><a href="/businesses">Bedrijven</a><a href="/events">Evenementen</a><a className="active" href="/deals">Aanbiedingen</a><a href="/signup">Delen</a></nav><a className="discovery-header-cta" href="/signup?kind=business">Aanbieding plaatsen</a></header>
