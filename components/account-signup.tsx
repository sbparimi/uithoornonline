  ...
  async function submit(e: FormEvent) {
    ...
    try {
      ...
      const { data, error: authError } = await supabase.auth.signUp({
        ...
        // The site uses passwordless magic-link login after registration. A random password satisfies Supabase password requirements without asking users to manage a second credential.
