...
export function HomePage() {
  ...
  return <main className="uo-agent-site" id="top">
    <header className="uo-agent-header">
      ...
      <nav className="uo-agent-nav" aria-label="Hoofdnavigatie"><a href="#how">Hoe het werkt</a><a href="#local">Lokaal</a></nav>
      ...
      {mobileOpen && <nav className="uo-agent-mobile-nav"><a href="#how" onClick={() => setMobileOpen(false)}>Hoe het werkt</a><a href="#local" onClick={() => setMobileOpen(false)}>Lokaal</a><a href="/signup">Voor ondernemers</a></nav>}
    </header>
